...
if __name__ == "__main__":
    ...
    prompt = "A young woman with long black hair, wearing a striped tank top, is seated on a white rug in a well-lit living room, playing an acoustic guitar with a look of concentration and enjoyment. She appears to be singing along, as indicated by her open mouth and relaxed demeanor. The room is cozy, with a cream-colored sofa and a white armchair, and the natural light creates a warm atmosphere. The woman's engagement with the music is evident through her focused expression and the way her fingers move on the fretboard. The scene remains consistent, highlighting her musical performance in a comfortable, homey setting."
